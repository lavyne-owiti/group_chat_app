...
import 'package:group_app/pages/profile_page.dart';
import 'package:group_app/pages/search_page.dart';
import 'package:group_app/services/auth_services.dart';
import 'package:group_app/services/database_services.dart';
import 'package:group_app/widgets/group_tile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  gettingUserData() async {
    ...
    //  getting a list of snapshots in our stream
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "you've not joined any group,tap on the add icon to create a gropup or also search for an existing group on the search icon",
            textAlign: TextAlign.center,
          ),
        ],
      ),
